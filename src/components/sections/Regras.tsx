const WHATSAPP_URL = 'https://wa.me/5541999999999?text=Olá!%20Li%20as%20regras%20e%20tenho%20interesse%20em%20alugar%20um%20quarto%20no%20Recanto%20Jardim%20Botânico.'
          ...
          <div className="bg-primary rounded-2xl p-8 text-center shadow-lg shadow-primary/20">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold px-8 py-3.5 rounded-full transition-colors shadow-lg shadow-green-900/30 text-sm"
              >
              ...
              <a
                href="/regras"
                className="w-full sm:w-auto inline-flex items-center justify-center bg-white/10 hover:bg-white/20 text-white font-semibold px-8 py-3.5 rounded-full transition-colors border border-white/20 text-sm"
              >
